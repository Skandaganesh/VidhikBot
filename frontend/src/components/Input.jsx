...
const Input = ({ getUserInput }) => {
  ...
  return (
    ...
    <input type="text" name='input' value={userInput} onChange={handleInput} placeholder='Enter your queries...' required autoComplete='off' className='py-1 outline-none border-0 flex-1 text-lg' />
